...
final class Version2025102014234 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
    	...
    	$this->addSql('CREATE TABLE DATE_INFO (id_date INT AUTO_INCREMENT NOT NULL, val_date DATE, type_date VARCHAR(255), PRIMARY KEY(id_date)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
